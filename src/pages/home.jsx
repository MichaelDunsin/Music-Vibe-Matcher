...
const HandleSubmit = async (text) => {
  const response = await fetch('http://localhost:3000/api/mood', { // note that during production, this url would change to the url of my project https://my-backend.onrender.com/api/mood
    method: 'POST',
